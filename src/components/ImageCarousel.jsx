...
export const ImageCarousel = ({
  ...
  return (
    <div className="flex flex-wrap gap-3">
      ...
      {images.length < 12 && (
        <label
          htmlFor="fileInputCarousel"
          className="rounded-xl border-2 aspect-square border-dashed border-light w-28 self-center justify-center items-center"
        >
          <div className="flex justify-center items-center h-full text-light cursor-pointer">
            <input
              id="fileInputCarousel"
              type="file"
              accept="image/*"
              style={{ display: "none" }}
