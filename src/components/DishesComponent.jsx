        ...
        <div id="dishes" className="flex flex-col border-b border-base-light p-4">
            ...
            {dishes.length >= visibleDishes && (
                <div className="flex items-center">
                    ...
                    {visibleDishes <= 2 && ( 
                            <button onClick={loadMoreDishes} className="text-primary px-2 cursor-pointer">View more</button>
                    )}
                    {visibleDishes > 2 && (
                            <button onClick={loadLessDishes} className="text-primary px-2 cursor-pointer">View less</button>
                    )}
                    <div className="bg-base-light flex-grow h-[1px]"></div>
                </div>
            )}
